...
Context-sensitive help (CSH) enhances ordinary online documentation by providing a topic for each screen within the application, tool, or portal. When you click the help icon, a window displays information that corresponds to the currently displayed application screen.
...
![Online Help diagram](/kbennett-samples/images/OLH1.png)
